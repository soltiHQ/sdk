//! # agentd-http
//!
//! Reference Solti agent with the HTTP/JSON transport. It accepts `Task`
//! resources over `/apis/solti.io/v1/tasks` and runs them as subprocesses. Running
//! without a reachable control plane (CP) is fine — the heartbeat retries with
//! backoff while the local API keeps serving.
//!
//! ## What this shows
//!
//! - Accepts `Task` resources over `/apis/solti.io/v1/tasks` and reports status
