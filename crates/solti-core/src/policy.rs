use solti_model::{AdmissionStrategy, BackoffStrategy, CreateSpec, RestartStrategy, Slot, TimeoutMs};

/// Runtime policy for a pre-built task.
///
/// This is similar to [`CreateSpec`] but does not carry [`solti_model::TaskKind`]:
