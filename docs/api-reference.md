...
| [`solti-core`](../crates/solti-core/src/lib.rs) | `SupervisorApi`, `SupervisorApiBuilder`, Taskvisor `OwnershipSnapshot`, `TaskState`, collection/output subscriptions, configuration, persistence sinks/status, typed conflicts/errors | [Management](managing-tasks.md), [configuration](configuration.md), [observability](observability.md), [persistence](persistence.md), [shutdown](cancellation-and-shutdown.md) |
